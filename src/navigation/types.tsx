...
import type { BookingStackParamList } from './booking-navigator';
import type { ChatsStackParamList } from './chats-navigator';
import type { FeedStackParamList } from './feed-navigator';

export type RootStackParamList = AuthStackParamList &
  FeedStackParamList &
  ChatsStackParamList &
  BookingStackParamList; //  & FooStackParamList & BarStackParamList
