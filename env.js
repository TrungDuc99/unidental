 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.unidental.staging
 */

const BUNDLE_ID = 'com.unidental'; // ios bundle id
const PACKAGE = 'com.unidental'; // android package name
const NAME = 'unidental'; // app name
